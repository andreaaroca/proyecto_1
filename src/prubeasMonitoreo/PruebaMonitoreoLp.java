...
public class PruebaMonitoreoLp {
	...
	private Map<Integer,Actividad> actividades1;
	private Map<String,Actividad> actividades1constructor;
    ...
    public void setUp( ) {
		...
		actividades1.put(actividad1.getIdActividad(),actividad1);
		profesorCreador1 = new Profesor("Juan", "juancalderon", "juan123", "Profesor");
		lp1=new LearningPath(15, "python", "introduccion a pyhton", "aprender el uso de for y while", "media", "3 horas", actividades1constructor, profesorCreador1);
